...
urlpatterns = [
    ...
    path('ativos/aprovar_solicitacao/<int:pk>/', views.aprovar_solicitacao, name='aprovar_solicitacao'),
    path('ativos/detalhes_ativo/<int:pk>/', views.detalhes_ativo, name='detalhes_ativo'),
    ...
    path('ativos/devolver_ativo/<int:pk>/', views.devolver_ativo, name='devolver_ativo'),
