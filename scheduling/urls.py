...
urlpatterns = [
    ...
    path('transporte/revisao/<int:pk>/', views.registrar_revisao, name='registrar_revisao'),
    path('veiculos/revisoes/', views.historico_revisoes, name='historico_revisoes'),
    ...
    path('transporte/manutencoes/', views.manutencoes, name='manutencoes'),
    path('transporte/retirar_chave/<int:pk>/', views.retirar_chave, name='retirar_chave'),
    ...
    path('transporte/checkout_viagem/<int:pk>/', views.checkout_viagem, name='checkout_viagem'),
    path('transporte/detalhes_viagem/<int:pk>/', views.detalhes_viagem, name='detalhes_viagem'),
    ...
    path('recusar_solicitacao/<int:pk>/', views.recusar_solicitacao, name='recusar_solicitacao'),
